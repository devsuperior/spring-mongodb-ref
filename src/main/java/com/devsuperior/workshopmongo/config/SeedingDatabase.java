...
public class SeedingDatabase implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		post1.addComment("Boa viagem mano!", Instant.parse("2022-03-21T21:30:00.00Z"), alex.getId(), alex.getName());
		post1.addComment("Aproveite!", Instant.parse("2022-03-22T10:30:00.00Z"), bob.getId(), bob.getName());
		
		post2.addComment("Tenha um ótimo dia!", Instant.parse("2022-03-23T08:30:00.00Z"), alex.getId(), alex.getName());
